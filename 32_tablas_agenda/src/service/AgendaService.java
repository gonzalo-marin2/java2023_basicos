...
public class AgendaService {
	...
	public boolean eliminar(String email) {
		//si se encuentra el email, lo borramos
		if(agenda.containsKey(email)) {
			agenda.remove(email);
			return true;
		}
	...
	public String[] nombres() {
		...
		return datos;*/
		//el método toArray de collection devuelve un array con los datos de la colección, a partir de un array vacío
